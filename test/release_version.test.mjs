...
test("1.1.0 release surfaces agree on the runtime version", async () => {
  ...
  assert.match(plist, /<key>CFBundleVersion<\/key>\s*<string>1\.1\.0<\/string>/);
  assert.match(gateway, /name: "CodexBridge Engine V2", version: "1\.1\.0"/);
});
