  ...
  <script>
    ...
    const i18nDict = {
      en: {
        ...
        vadThresholdHint: "Sound power below this level is treated as silence (default: -42.0 dB).",
        labelVadDuration: "VAD Required Silence (seconds)",
        vadDurationHint: "Auto-stops recording after this duration of silence (default: 1.5s).",
      ...
      zh: {
        ...
        vadThresholdHint: "环境分贝低于此值将被判定为静音（默认：-42.0 dB）。",
        labelVadDuration: "静音检测时长 (秒)",
        vadDurationHint: "说话停顿超过此时间将自动终止录音（默认：1.5s）。",
